...
2. `Severity_Klaim.ipynb` — estimasi distribusi Gamma untuk severitas klaim
3. `Konvergensi_Model.ipynb` — pengujian konvergensi model
4. `Perhitungan_Peluang_Kebangkrutan.ipynb` — perhitungan ψ(u) dan uji sensitivitas safety loading
